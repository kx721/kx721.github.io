...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        ...
        items: [
          ...
          {
            text: '前端文章',
            items: [{ text: 'http', link: '/pages/a50959/' }],
          },
          {
            text: '学习笔记',
            items: [{ text: 'javaScript基础', link: '/pages/45d540/' }],
          },
        ],
      },
      {
    ...
    bodyBgImg: ['/img/bg1.png', '/img/bg2.jpg', '/img/bg3.jpg'], // body背景大图，默认无。 单张图片 String | 多张图片 Array, 多张图片时隔bodyBgImgInterval切换一张。
    ...
    blogger: {
      avatar:
        'https://th.bing.com/th/id/OIP.6DMeMeIZkgs_kzszD0U-xQHaHa?w=164&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7',
      name: '空相',
      // slogan: '前端界的小学生',
    },
